...
2. El método de aislamiento basado en bordes: este método utiliza dos vías, una para datos lentos y otra para datos de alta velocidad. Un aislante digital típico está compuesto por una sección de transmisor (TX) y una sección de receptor (RX). Están aislados mediante el acoplamiento capacitivo. 
